...
# Slack Emoji URL Dump
# go to the emoji page in the browser, inspect, refresh the page. There'll be a file called "emoji.list" or something and download the json that comes from it
